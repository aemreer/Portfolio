    ...
    return (
        <section className="contact container">
            ...
            <div className="contact-links">
                <a href="https://www.linkedin.com/in/aemreer/" target="_blank" className="contact-box">
                ...
                <a href="https://github.com/aemreer" target="_blank" className="contact-box">
                    <FaGithub className="icon" />
                    <span>GitHub</span>
                    <span className="arrow">↗</span>
                </a>

                <a href="mailto:ahmetemreer32@gmail.com" className="contact-box">
